...
public class AdminSnapshotPayloadTest {
    ...
    public void test_all_args_constructor_null_coerces_lists() {
        final var payload = new AdminSnapshotPayload(4L, null, null, null, null);
        ...
        assertTrue(payload.getSchemas().isEmpty());
    }
    ...
    public void test_setters() {
        ...
        schemas.add("db|coll", new JsonObject());
        payload.setSchemas(schemas);
        ...
        assertTrue(payload.getSchemas().has("db|coll"));
    }
