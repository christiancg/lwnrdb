...
public class MathBuiltinsTest {
    ...
    // f16round must not double-round through float32: a double one ULP above the exact float16 halfway
    // point (2^-25) has to round up to the smallest subnormal (2^-24), not collapse to 0.
    @Test
