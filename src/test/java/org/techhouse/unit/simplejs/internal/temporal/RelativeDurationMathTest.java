...
// Direct API coverage: these paths are reachable from script only through the test262 harness, which runs
// in a separate worker JVM that JaCoCo does not measure.
