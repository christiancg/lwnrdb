...
public final class GlobalScope {
    ...
    public static JsGlobalObject install(Environment global, EventLoop eventLoop, Invoker invoker,
        ...
        constructor(global, "Array", ArrayBuiltins.create(invoker, eventLoop, ops, intrinsics), intrinsics.arrayProto);
        ...
        constructor(global, "Promise", PromiseBuiltins.create(eventLoop, invoker, intrinsics), intrinsics.promiseProto);
        ...
        constructor(global, "WeakMap", MapBuiltins.create(iterableToList, invoker, ops, true), intrinsics.weakMapProto);
        ...
        constructor(global, "ArrayBuffer", ArrayBufferBuiltins.arrayBuffer(ops), intrinsics.arrayBufferProto);
        constructor(global, "DataView", DataViewBuiltins.dataView(ops), intrinsics.dataViewProto);
        ...
        intrinsics.typedArrayProto.setFlags("constructor", JsObject.PropertyFlags.HIDDEN);
