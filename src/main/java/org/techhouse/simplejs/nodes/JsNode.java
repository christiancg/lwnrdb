...
public abstract class JsNode {
    public enum NodeType {
        PROGRAM, VARIABLE_DECLARATION, VARIABLE_DECLARATOR, BLOCK_STATEMENT, IF_STATEMENT, WHILE_STATEMENT, FOR_STATEMENT, RETURN_STATEMENT, BREAK_STATEMENT, CONTINUE_STATEMENT, EXPRESSION_STATEMENT, FUNCTION_DECLARATION, EMPTY_STATEMENT, NUMBER_LITERAL, STRING_LITERAL, BOOLEAN_LITERAL, NULL_LITERAL, UNDEFINED_LITERAL, REGEX_LITERAL, TEMPLATE_LITERAL, IDENTIFIER, THIS_EXPRESSION, ARRAY_EXPRESSION, OBJECT_EXPRESSION, PROPERTY, UNARY_EXPRESSION, UPDATE_EXPRESSION, BINARY_EXPRESSION, LOGICAL_EXPRESSION, ASSIGNMENT_EXPRESSION, CONDITIONAL_EXPRESSION, CALL_EXPRESSION, MEMBER_EXPRESSION, NEW_EXPRESSION, FUNCTION_EXPRESSION, ARROW_FUNCTION_EXPRESSION
    }
