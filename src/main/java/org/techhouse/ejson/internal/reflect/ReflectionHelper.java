package org.techhouse.ejson.internal.reflect;

import org.techhouse.ejson.JsonIOException;
...
public class ReflectionHelper {
  ...
  private static String getInaccessibleTroubleshootingSuffix(Exception e) {
    ...
    if (e.getClass().getName().equals("java.lang.reflect.InaccessibleObjectException")) {
      ...
      String troubleshootingId = message != null && message.contains("to module org.techhouse.ejson")
  ...
  public static String getAccessibleObjectDescription(AccessibleObject object, boolean uppercaseFirstLetter) {
    String description;
      ...
      switch (object) {
          case Field field -> description = "field '" + fieldToString(field) + "'";
          case Method method -> {
          ...
          case Constructor<?> constructor -> description = "constructor '" + constructorToString(constructor) + "'";
          case null, default -> description = "<unknown AccessibleObject> " + object.toString();
      }
  ...
  public static RuntimeException createExceptionForUnexpectedIllegalAccess(
    ...
    throw new RuntimeException("Unexpected IllegalAccessException occurred."
        + " Certain ReflectionAccessFilter features require Java >= 9 to work correctly. If you are not using"
        + " ReflectionAccessFilter, report this to the EJson maintainers.",
        exception);
  }
