 ...
 * EJsonBuilder} for them to take effect: <pre>   {@code
 *
 ...
 * multiset's type token. A {@code EJson} is passed in to {@code create} for
 ...
 *       TypeAdapter<?> elementAdapter = eJson.getAdapter(TypeToken.get(elementType));
 ...
 * the foundation of how EJson converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
   ...
   * support {@code type}.
   */
  <T> TypeAdapter<T> create(EJson eJson, TypeToken<T> type);
}
