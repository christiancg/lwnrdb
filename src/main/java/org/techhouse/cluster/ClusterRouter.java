...
public class ClusterRouter {
     ...
     *         established).
     */
    public String forward(OperationRequest request, String rawJson, boolean transactionActive) {
        if (!clusterConfig.isEnabled() || transactionActive || !ROUTABLE.contains(request.getType())) {
            return null;
        }
        ...
        return forwardToOwner(request.getType(), rawJson, ownerAddress);
    }

    private String forwardToOwner(OperationType type, String rawJson, String ownerAddress) {
